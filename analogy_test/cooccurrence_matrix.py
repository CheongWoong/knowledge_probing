...
class CooccurrenceMatrix():
    def __init__(self, pretraining_dataset_name):
        with open(f"../../impact_of_cooccurrence/data_statistics/entity_set/merged/all_subjects.json", "r") as fin:
            self.subject_idx = json.load(fin)
        with open(f"../../impact_of_cooccurrence/data_statistics/entity_set/merged/all_objects.json", "r") as fin:
            self.object_idx = json.load(fin)
        with open(f"../../impact_of_cooccurrence/data_statistics/entity_set/merged/all_entities.json", "r") as fin:
        ...
        self.cooccurrence_matrix = np.load(f'../../impact_of_cooccurrence/data_statistics/cooccurrence_matrix/{pretraining_dataset_name}/cooccurrence_matrix.npy')
        self.occurrence_matrix = np.load(f'../../impact_of_cooccurrence/data_statistics/occurrence_matrix/{pretraining_dataset_name}/occurrence_matrix.npy')
